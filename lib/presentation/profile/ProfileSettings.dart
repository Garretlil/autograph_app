        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                _buildInfoSection("${AppLocalizations.of(context)!.personal}:", ""),
                SizedBox(height: spacingFactor * 0.1),
                _buildInfoSection("${AppLocalizations.of(context)!.name}: ", AppPrefs.prefs.getString('name')!),
                const Divider(),
                SizedBox(height: spacingFactor * 0.1),
                _buildInfoSection("${AppLocalizations.of(context)!.surname}: ", AppPrefs.prefs.getString('surname')!),
                const Divider(),
                SizedBox(height: spacingFactor * 0.1),
                _buildInfoSection(
                  "${AppLocalizations.of(context)!.phone}: ",
                  AppPrefs.prefs.getString('phoneNumber')!,
                ),
                const Divider(),
                SizedBox(height: spacingFactor * 0.1),
                    ...
                    child: Container(
                      ...
                      child: InkWell(
                        onTap: () async {
                          try {
                            final sessionKey =
                            AppPrefs.prefs.getString('session_key');
                            if (sessionKey == null || sessionKey.isEmpty) {
                              _resetAuthState();
                              return;
                            }
                            final response =
                            await AuthService(Dio()).logout(sessionKey);
                        ...
                        child: Ink(
                          ...
                          child: Container(
                            ...
                            alignment: Alignment.center,
                            child: Text(
                              // Используем локализацию вместо прямых строк
